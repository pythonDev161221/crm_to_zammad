...
# ══════════════════════════════════════════════
# PART 2 — STATION MANAGER: INVITE
# ══════════════════════════════════════════════
add_heading(doc, '2. Для руководителя станции: приглашение сотрудника', level=1)
add_para(doc,
...
add_heading(doc, '2.1 Как создать и отправить ссылку', level=2)
...
add_heading(doc, '2.2 Важные правила', level=2)
add_bullet(doc, 'Одна ссылка — один сотрудник. После регистрации ссылка становится недействительной.')
add_bullet(doc, 'Для следующего сотрудника нажмите «Создать новую ссылку».')
...
add_note(doc,
    'Не передавайте ссылку нескольким людям одновременно — '
    'зарегистрируется только первый, кто её использует.')
