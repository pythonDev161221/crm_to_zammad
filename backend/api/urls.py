...
urlpatterns = [
    ...
    path('manage/supply-workers/<int:pk>/', views.ManageSupplyWorkerDeleteView.as_view(),
         name='manage-supply-worker-delete'),
    path('manage/station-managers/', views.ManageStationManagersView.as_view(),
         name='manage-station-managers'),
    path('manage/station-managers/<int:pk>/', views.ManageStationManagerDeleteView.as_view(),
         name='manage-station-manager-delete'),
    ...
    path('manage/stations/<int:pk>/remove-manager/', views.StationRemoveManagerView.as_view(),
         name='station-remove-manager'),
